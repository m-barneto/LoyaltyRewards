...
export default function MemberPage() {
  ...
  function loadMember() {
    axios.get('https://localhost:7223/loyaltymember', { params: { memberId: id } })
  ...
  function loadTransactions() {
    axios.get('https://localhost:7223/loyaltymember/transactions', { params: { memberId: id } })
      .then(function (response) {
      ...
      {member &&
        <div className='mt-3 p-2 bg-dark rounded'>
          <div className='d-flex align-items-center justify-content-center'>
            <h1 id='example-custom-modal-styling-title'>{getName(member['firstName'], member['lastName'])}</h1>
          </div>
